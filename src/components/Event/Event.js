...
import game from '../../static/img/event-game.svg'
import race1 from '../../static/img/event-race1.svg'
import race2 from '../../static/img/event-race2.svg'
import run from '../../static/img/event-run.svg'
...
const Event = () => {
    const eventCard =[
        ...
        {id:2,img:race1,h1:raceTitle,date:"23 АВГУСТА",desc:"OCR. ЗАБЕГ С ПРЕПЯТСТВИЯМИ",city:"Москва",linear:"linear-gradient(269.65deg, #F77676 -18.16%, rgba(210, 53, 53, 0) 100%)"},
    ...
    return (
        <div className={cls.event}>
            ...
            <div className={cls.eventsList}>
                {eventCard.map((item) => {
                    return(
                        <div key={item.id} className={cls.eventItem} style={{
