...
import { Formik, Form, useFormik, yupToFormErrors } from "formik";
...
const Tests = () => {
    ...
    const validateSchema = Yup.object().shape(
        tests.reduce((state, { id }) => {
            return { ...state, [id]: Yup.mixed().typeError('обязательно').test('value validate', 'обязательно' , (value) => {
                        ...
                        if (type === 'radio') {
                            ...
                            if (values[questionId]) {
                                ...
                                if (values[questionId].some(ansId => ansId === answerId)) {
                                    ...
                                    setFieldValue(questionId, values[questionId].filter(ansId => ansId !== answerId))
                                } else {
                        ...
                        <form onSubmit={handleSubmit}>
                            {tests.map(
                                ({ id, type, answers, helpText, label, count, img }) => {
                                    return (
                                        <div style={{ display: "flex"}} className={cls.testBlock} key={id}>
                                            <img src={img} className={cls.Img} />
                                            <div  className={cls.testQues}>
                                                <div>
                                                    <h2 className={cls.count}>{count}</h2>
                                                    <div className={cls.line}></div>
                                                    <p className={cls.question}>{label} <span className={cls.attention}>{helpText}</span> </p> <br />
                                                </div>
                                                <FormControl onChange={(e) => handleChange(type, id, e.target.value)} className={cls.form}>
                                                    <RadioGroup
                                                                ...
                                                                ({ id: qId, answer }) => (
                                                                    <div>
                                                                        <FormControlLabel
                                                                            ...
                                                                            control={type === "radio" ? <Radio className={cls.radio}/> : <Checkbox className={cls.checkbox}/>}
                                                                            label={answer}
        ...
        answers: [
            {
                ...
                answer: "Обеспечение мероприятий Лиги Героев волонтерским составом, повышение внутренней мотивации и желания развиваться, проведение предварительной подготовки и обучения волонтеров перед мероприятиями "
            },
            {
                id: "test_2_question_2",
                answer: "Необеспечение мероприятий Лиги Героев волонтерским составом, повышение внутренней мотивации и желания развиваться, проведение предварительной подготовки и обучения волонтеров после мероприятия"
            },
            {
                id: "test_2_question_3",
                answer: "Обеспечение мероприятий Лиги Героев волонтерским составом, повышение внутренней мотивации и желания развиваться, проведение предварительной подготовки и обучения волонтеров после мероприятия   "
            }
        ]
    },
    {
        ...
        answers: [
            {
                ...
                answer: "Волонтер – волонтер/судья – старший волонтер – координатор волонтерского центра "
            },
            {
                id: "test_4_question_2",
                answer: "Стажер – старший волонтер – волонтер – координатор ВЦ – волонтер/судья "
            },
            {
                id: "test_4_question_3",
                answer: "Старший волонтер – волонтер – координатор ВЦ – волонтер/судья – стажер "
            },
            {
                id: "test_4_question_4",
                answer: "Волонтер – координатор ВЦ – волонтер/судья – Стажер  – старший волонтер"
            }
        ]
    },
    {
