...
const accordDetails =[
    {id:1,img:kurs,linear:"linear-gradient(269.65deg, #F77676 -18.16%, rgba(210, 53, 53, 0) 100%)",name:"НАЗВАНИЕ КУРСА #1",days:"25"},
    {id:2,img:kurs,linear:"linear-gradient(267.53deg, #36E65D -0.27%, rgba(53, 163, 210, 0) 100%)",name:"НАЗВАНИЕ КУРСА #2",days:"25"},
    {id:3,img:kurs,linear:"linear-gradient(267.53deg, #9F76F7 -0.27%, rgba(53, 154, 210, 0) 100%)",name:"НАЗВАНИЕ КУРСА #3",days:"25"},
    {id:4,img:kurs,linear:"linear-gradient(269.65deg, #F77676 -18.16%, rgba(210, 53, 53, 0) 100%)",name:"НАЗВАНИЕ КУРСА #4",days:"25"}
]
const StudyAccord = () => {
    return(
                        ...
                        <Accordion className={cls.accordion}>
                            ...
                            >
                                <Typography className={cls.top}>
                                    ...
                                    <p>{accord.desc}</p></Typography>
                            </AccordionSummary>
                            <AccordionDetails className={cls.accordDetail}>
                                <Typography className={cls.bottom}>
                                    {
                                        accordDetails.map(detail =>{
                                            return(
                                                <div className={cls.details}>
                                                    <div className={cls.detailImg} style={{background: `${detail.linear} ,url(${detail.img})`}}>
                                                        <p>{detail.name}</p>
                                                    </div>
                                                    <div className={cls.detailInfo}>
                                                        ...
                                                        <div className={cls.detailLine}></div>
