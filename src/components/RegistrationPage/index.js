...
const handleSubmit = async ({email, password, first_name, last_name, vk, date_birthday, city, role, phone_number}) => {
    try {
        let data = {email, password, first_name, last_name, vk, date_birthday, city, role, phone_number}
        return await $api.post("/accounts/auth/users/", data)
    } catch (e) {
            ...
            >
                {({values, errors, touched, handleChange, setFieldValue}) => (
                    ...
                    >
                        ...
                        <FormControl name={"role"} className={classes.FormControl} value={values.role}
                                     onChange={handleChange}
                        >
                            <RadioGroup
                                row
